    ...
    <div class="max-w-2xl mx-auto">
        ...
        <?php if ($status === 'approved'): ?>
            ...
            <div class="bg-white p-12 rounded-[2.5rem] shadow-2xl border border-gray-100 text-center animate-fade-in">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-2">You're a Verified Landlord</h3>
                <p class="text-gray-500 mb-8 max-w-sm mx-auto">Your identity has been successfully confirmed. You can now proceed to list and manage properties in a minute.</p>
                
                <div class="flex flex-col gap-4">
                    <a href="<?= APP_URL ?>/landlord/dashboard" class="w-full py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-slate-800 transition-all shadow-lg shadow-slate-200">
                        Go to My Dashboard
                    </a>
        ...
        <?php elseif ($status === 'pending'): ?>
            ...
            <div class="bg-white p-12 rounded-[2.5rem] shadow-xl border border-gray-100 text-center">
                ...
                <p class="text-gray-500 mb-8">Our team is currently reviewing your documents. We'll notify you as soon as you're approved to list properties.</p>
                <a href="<?= APP_URL ?>/landlord/dashboard" class="text-blue-600 font-bold hover:underline">Return to Dashboard</a>
            </div>
        ...
        <?php else: ?>
            ...
            <div class="bg-white p-10 rounded-[2.5rem] shadow-xl border border-gray-100">
                <div class="mb-8 border-b border-gray-50 pb-6">
                    <h3 class="text-xl font-bold text-gray-900">Landlord KYC Verification</h3>
                    <p class="text-sm text-gray-500">Submit your details to start listing properties on the marketplace.</p>
                </div>
                ...
                <form action="<?= APP_URL ?>/landlord/verify-submit" method="POST" enctype="multipart/form-data" class="space-y-6">
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">BVN or NIN Number</label>
                            <input type="text" name="bvn_nin" required placeholder="Enter your valid BVN or NIN" class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none transition-all">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Full Residential Address</label>
                        ...
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Government ID Upload</label>
