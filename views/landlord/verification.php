<div class="min-h-screen bg-gray-50 py-12 px-6">
    <div class="max-w-2xl mx-auto">
        <div class="text-center mb-10">
            ...
            <p class="text-gray-500 mt-2">To list properties, you must first complete our KYC verification process.</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
            ...
            <form action="<?= APP_URL ?>/landlord/verify-submit" method="POST" enctype="multipart/form-data" class="space-y-6">
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">BVN or NIN Number</label>
                        <input type="text" name="bvn_nin" required class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all">
                    </div>
                    <div>
