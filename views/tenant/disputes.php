<div class="mb-8">
    <h1 class="text-3xl font-bold mb-2">Dispute Center</h1>
    <p class="text-gray-600">Manage disputes for your active rentals and secured payments.</p>
</div>
...
<?php if(empty($escrowItems)): ?>
    <div class="bg-white p-12 rounded-3xl shadow-sm border border-gray-100 text-center">
        ...
        <h3 class="text-xl font-bold text-gray-800 mb-2">No Active Payments</h3>
        <p class="text-gray-500">You don't have any secured payments to dispute.</p>
    </div>
<?php else: ?>
                ...
                <div>
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <span class="text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full 
                            <?= $item['status'] == 'escrow_hold' ? 'bg-blue-50 text-blue-600 border border-blue-100' : 'bg-green-50 text-green-600 border border-green-100' ?>">
